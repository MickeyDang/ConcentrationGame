Public Class Form3
    'tetris type music
    'freeze type music
    Dim Cardprop(17) As Integer 'array element is the card number.  The value of the element is the card type (ie ace of hearts)
    Dim cardval(8) As Integer ' array element is just element.  The value is a number corresponding to the type of card (ie 3 of hearts)
    Dim cardhistory(17) As Integer 'array stores the element numbers of cardprop that are assigned values on form load. this is to prevent overwrites
    ...
    Dim cardnotpick(17) As Integer ' This array stores all the cards (actual location not val) that are flipped over and therefore can't be re-selected
    ...
    Sub ValtoCard(ByVal A As Integer, ByVal B As Integer)
        ...
        If cardhistory(0) <> 0 And cardhistory(1) <> 0 And cardhistory(2) <> 0 And cardhistory(3) <> 0 And cardhistory(4) <> 0 And _
            ...
            And cardhistory(13) <> 0 And cardhistory(14) <> 0 And cardhistory(15) <> 0 And cardhistory(16) <> 0 Then
            cardhistory(17) = 0
        ...
        If cardpos <> cardhistory(0) And cardpos <> cardhistory(1) And cardpos <> cardhistory(2) And cardpos <> cardhistory(3) _
            ...
            And cardpos <> cardhistory(14) And cardpos <> cardhistory(15) And cardpos <> cardhistory(16) And cardpos <> cardhistory(17) Then
    ...
    Private Sub Form3_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For repeat2 As Integer = 0 To 8
            Dim genval As Integer
            Randomize()
            genval = Rnd() * 12

            If genval <> cardval(0) And genval <> cardval(1) And genval <> cardval(2) And genval <> cardval(3) And genval <> cardval(4) And genval <> cardval(5) And genval <> cardval(6) And genval <> cardval(7) And genval <> cardval(8) Then
        ...
        For repeat As Integer = 0 To 17

            Call ValtoCard(repeat, n)

            If repeat <= 7 Then
                n += 1
            ElseIf repeat = 8 Then
                n = n
            ElseIf repeat > 7 Then
                n -= 1
            End If
        Next
    ...
    Private Sub Label1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Label1.Click
        MessageBox.Show(Cardprop(0) & vbCrLf & Cardprop(1) & vbCrLf & Cardprop(2) & vbCrLf & Cardprop(3) & vbCrLf & Cardprop(4) & vbCrLf & Cardprop(5) & vbCrLf & Cardprop(6) & vbCrLf & Cardprop(7) & vbCrLf & Cardprop(8) & vbCrLf & Cardprop(9) & vbCrLf & Cardprop(10) & vbCrLf & Cardprop(11) & vbCrLf & Cardprop(12) & vbCrLf & Cardprop(13) & vbCrLf & Cardprop(14) & vbCrLf & Cardprop(15) & vbCrLf & Cardprop(16) & vbCrLf & Cardprop(17))
    End Sub
